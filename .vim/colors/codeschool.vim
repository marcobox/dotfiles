...
" Changed value of lineNr aswell (default was 18)
...
hi Search ctermfg=16 ctermbg=107 cterm=underline guifg=NONE guibg=NONE gui=underline
...
" Modified normal BG to make it transparent (default was 16)
...
" Commented this to hide ugly blue background where there is no text (end of file)
